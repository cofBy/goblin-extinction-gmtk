...
public class FEEL : MonoBehaviour
{
    ...
    public CinemachineHardLockToTarget cam;
    public static CinemachineHardLockToTarget staticCam;
    ...
    public static IEnumerator CameraShake(float intensity, float duration, Vector3 multiplayer)
    {
        ...
        Vector3 org = staticCam.transform.position;
        ...
        while (timer > 0)
        {
            ...
            staticCam.transform.position = org + Offset;

            timer -= Time.deltaTime;
            yield return null;
        }
        staticCam.transform.position = org;
